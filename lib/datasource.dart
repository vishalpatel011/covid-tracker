...
Color primaryBlack= Color(0xff0b013b);

class DataSource{
  static String quote = "Ultimately, the greatest lesson that COVID-19 can teach humanity is that we are all in this together.";
